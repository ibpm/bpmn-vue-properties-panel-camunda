...
export default {
  ...
  'Config': '配置',
  'CallActivity Type': '引擎类型',
  'Called Element': 'BPMN主键',
  'Business Key Expression': '业务主键',
  ...
  'Field Injections': '成员变量注入',
  'Field': '成员变量',
  'Connector': '连接器',
  'Custom Fields': '个性化成员变量',
  'Java Class': 'Java类',
  'Script Format': '脚本语言',
  'Script': '脚本',
  'Condition Type': '条件类型',
