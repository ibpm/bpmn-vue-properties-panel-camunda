  ...
  <div>
    <el-tabs v-if="templates.length" v-model="tabName" type="card" @tab-click="clickTab">
      <el-tab-pane :label="$customTranslate('General')" name="general">
        <General ref="general" :moddle="moddle" :form="form" :rules="rules" @write="write">
          <template #custom>
            <slot name="custom" />
          </template>
        </General>
      ...
      <el-tab-pane :label="$customTranslate('Template')" name="templates">
        <Templates ref="templates" :moddle="moddle" :form="form" :templates="templates" @sync="sync" @write="write" />
      </el-tab-pane>
    </el-tabs>
    <General v-else ref="general" :moddle="moddle" :form="form" :rules="rules">
      <template #custom>
        <slot name="custom" />
      </template>
    </General>
